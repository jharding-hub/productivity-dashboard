export default function UrgeLogModal() {
  return (
    <div className="modal-blur-overlay" id="urgeModal" role="dialog" aria-modal="true" aria-labelledby="urgeModalTitle">
      ...
      <div className="modal-blur-panel" style={{ width: 'min(560px,95vw)' }}>
        <div className="modal-blur-header">
          <div className="modal-blur-title" id="urgeModalTitle">{'✋'} Urge Log</div>
          <button className="modal-blur-close" onClick={() => window.closeUrgeModal()} aria-label="Close">&#10005;</button>
        </div>
